...
export const projects: Project[] = [
  ...
  },
  {
    ...
    contextNote:
      "A recommendation system for LLMs based on structured metadata from the HuggingFace Hub.",
    sections: [
      {
        title: "The Problem",
      ...
      {
        title: "Context",
        body: "Ueses the Soft Actor Critic (SAC) algorithm to learn a policy for recommending models based on user preferences and model features. The state space includes engineered features from model metadata, and the action space consists of recommending specific models. Rewards are based on user feedback and engagement metrics.",
      },
    ],
  },
  {
